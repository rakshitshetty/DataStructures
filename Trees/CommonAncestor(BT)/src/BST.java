...
//////////////////////////////////////////////////	
	...
	{
		if(covers(root.leftchild,a)&& covers(root.leftchild,b))
		{
			commonAncestor(root.leftchild,a,b);
		}
		if(covers(root.rightchild,a)&& covers(root.rightchild,b))
		{
			commonAncestor(root.rightchild,a,b);
		}
		return root;
	}
	
	public boolean covers(Node a,Node b)
	{
		if(a==null)
		{
			return false;
		...
		return (covers(a.leftchild,b)||covers(a.rightchild,b));
